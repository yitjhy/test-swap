...
const LPShare = () => {
  return (
    <LPShareWrapper>
      ...
      <div className="lp-share-item-wrapper">
        <span className="lp-share-label">UNI</span>
        <span className="lp-share-value">0.141722</span>
      </div>
      <div className="lp-share-item-wrapper">
        <span className="lp-share-label">ETH</span>
        <span className="lp-share-value">0.0216772</span>
      </div>
    </LPShareWrapper>
  )
}
