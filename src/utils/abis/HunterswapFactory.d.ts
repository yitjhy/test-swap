...
interface HunterswapFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getKeccakOfPairCreationCode()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getKeccakOfPairCreationCode",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class HunterswapFactory extends Contract {
  ...
  interface: HunterswapFactoryInterface;
  ...
  functions: {
    ...
    getKeccakOfPairCreationCode(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  getKeccakOfPairCreationCode(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getKeccakOfPairCreationCode(overrides?: CallOverrides): Promise<BigNumber>;

    "getKeccakOfPairCreationCode()"(
      overrides?: CallOverrides
    ): Promise<BigNumber>;
