      ...
      <SwapWrapper>
        <div className="nav-wrapper">
          ...
          <div className="operations">
            <button className="create-pair-btn">Creat a Pair</button>
            <button className="increase-lp-btn">Increase Liquidity</button>
          </div>
        </div>
        ...
        <div className="join-lp-tip">
          Dont see a pool you joined? <span className="import-btn">Import It</span>
        </div>
      </SwapWrapper>
    </LPWrapper>
  )
