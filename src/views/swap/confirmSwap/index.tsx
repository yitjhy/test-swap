    ...
    <ConfirmWrapWrapper>
      <div className="wrap-content">
        <div className="wrap-switch-wrapper">
          ...
          <div className="currency-row-wrapper">
            <Image className="currency-logo" src={currencyIcon} alt="" width={30} height={30} />
            <span className="currency-amount">1642</span>
        ...
        <div className="wrap-detail-wrapper">
          <div className="wrap-detail-item-wrapper">
            ...
            <span className="wrap-detail-value">15.5592 USDT / ETH</span>
          </div>
          <div className="wrap-detail-item-wrapper">
            <span className="wrap-detail-label">Received</span>
            <span className="wrap-detail-value">0.01549 USDT</span>
          </div>
          <div className="wrap-detail-item-wrapper">
            <span className="wrap-detail-label">Price Impact</span>
            <span className="wrap-detail-value">0.22%</span>
          </div>
          <div className="wrap-detail-item-wrapper">
            <span className="wrap-detail-label">Trade Fee</span>
            <span className="wrap-detail-value">0.00000 BNB</span>
          </div>
        </div>
      </div>
