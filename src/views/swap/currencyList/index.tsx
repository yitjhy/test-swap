...
import NotTradedWaning from '@/views/swap/currencyList/notTradedWaning'
...
const SelectCurrency = () => {
  ...
  return (
    <SelectCurrencyWrapper>
      ...
      />
      <RecommandCurrency>
        {[1, 23, 3].map((item, index) => (
          <div className="currency-btn" key={index}>
      ...
      <div className="currency-list-wrapper">
        {[1, 2, 3, 4].map((item, index) => {
          return (
            <div className="currency-item-wrapper" key={index}>
              <div className="currency-base-info-wrapper">
                <Image src={imgSrc} alt="" width={24} height={24} />
                <div className="currency-name-symbol-wrapper">
                  <span className="currency-name">Wrapped Ether</span>
                  <span className="currency-symbol">WETH</span>
                </div>
                {index % 2 === 1 && (
                  <Image
                    src="/warning.png"
              ...
              {index % 2 === 1 ? (
                <div className="currency-balance-wrapper">
                  <span className="currency-balance">0.3848</span>
