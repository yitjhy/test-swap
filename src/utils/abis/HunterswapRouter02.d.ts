...
interface HunterswapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class HunterswapRouter02 extends Contract {
  ...
  interface: HunterswapRouter02Interface;
